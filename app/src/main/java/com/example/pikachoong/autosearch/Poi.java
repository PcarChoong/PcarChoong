package com.example.pikachoong.autosearch;

public class Poi {
    private String id; // 지역 id
    private String name; // 지역 명칭
    private String telNo; // 전화번호
    private String frontLat; // 전면 위도
    private String frontLon; // 전면 경도
    private String noorLat; // 북위도
    private String noorLon; // 북경도
    private String upperAddrName; // 시
    private String middleAddrName; // 구
    private String lowerAddrName; // 동
    private String detailAddrName; // 상세 주소
